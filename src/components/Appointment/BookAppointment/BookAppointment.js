...
const BookAppointment = ({ bookingDate }) => {
  const formatDate = new Date(bookingDate).toDateString();
  const bookingData = [
    {
  ...
  return (
    <section className="container book-appointment">
      <div className="book-appointment__header">
        <h3>Available Appointments on {formatDate} </h3>
      </div>
